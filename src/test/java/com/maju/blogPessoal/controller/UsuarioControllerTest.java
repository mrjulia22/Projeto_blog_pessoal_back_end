package com.maju.blogPessoal.controller;
...
import com.maju.blogPessoal.repository.UsuarioRepository;
import com.maju.blogPessoal.service.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L,
				"Paulo Antunes", "https://i.imgur.com/JR7kUFU.jpg","paulo_antunes@email.com.br", "13465278"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Maria da Silva","https://i.imgur.com/T12NIp9.jpg", "maria_silva@email.com.br", "13465278"));
